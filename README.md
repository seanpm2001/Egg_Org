...
![EggIncIcon_650x640.jpeg failed to load. The image may have been moved, the URL may be incorrect (check capitalization) the file may be corrupt, or your web browser implementation doesn't support the image linking method used.](/EggIncIcon_650x640.jpeg)
...
[Sorting options unavailable](https://github.com/Egg_Org/)
...
# Egg_Org
Egg Org is a free and open source alternative to Egg inc. Completely in-app purchase and advertisement-free. Development focus is currently only for Linux, BSD and BSD/Darwin. Windows, and otherOS support coming soon. 
 
***

## About

See above. Egg Org is an expansion of Egg Inc, and is a free and open source alternative, with no in-app purchases. It expands the game by changing many things, and allowing for different types of birds and reptiles to be used on farms, along with new quests, new content, new graphics, and more.
...
The website currently uses the Slate theme. If you are not on the website, the website can be found by [clicking/tapping here](https://github.com/Egg-org/Egg-org/).

***

## Game icon

This game currently doesn't have its own icon, so it uses the Egg Inc icon as a placeholder.

I intend for the game to have a egg like icon in the future, and not a bird, as this game will encompass so many different birds, but also reptiles and other egg-laying animals.

***

## Wiki

[Click/tap here to view this projects Wiki](https://github.com/seanpm2001/Egg_Org/wiki/)
...
[Join the discussion on GitHub](https://github.com/seanpm2001/Egg_Org/discussions/)
...
This project was started as an original project nearing the end of my first year of GitHub. It hasn't had too extensive of a development history yet.
...
> * 1. [seanpm2001](https://github.com/seanpm2001/) - 31 commits (As of Tuesday, July 13th 2021 at 6:33 pm)
...
File version: `1 (Tuesday, July 13th 2021 at 6:33 pm)`
...
**Version 1 (Tuesday, July 13th 2020 at 6:33 pm)**
